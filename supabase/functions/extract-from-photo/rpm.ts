...
//
// Duplicado a propósito de ai-assistant/rpm.ts y no importado entre carpetas:
// mismo motivo que GeminiError/parseRateLimit en index.ts — cada Edge Function
// se despliega sola, y compartir un módulo entre las dos ataría sus deploys.
